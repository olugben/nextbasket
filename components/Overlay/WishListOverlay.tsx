              ...
              <>
                ...
                <main className="flex-1 overflow-x-hidden h-full">
                  {wishListItems?.map((item: IProductItem) => (
                   ...
                   {/* <ProductItem {...item} item={item} add={addToWishList} remove={removeFromWishList} increase={increaseWishListItemQuantity} decrease={decreaseWishListItemQuantity} quantity={() => currentWishListItemQuantity(item.id/> */}
                    </React.Fragment>
                  ))}
                </main>
              </>
